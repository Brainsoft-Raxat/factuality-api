...
class GenreScoreCategory(BaseModel):
    OPINION: float = 0.0
    SATIRE: float = 0.0
    REPORTING: float = 0.0
...
class ScoreData(BaseModel):
    ...
    genre: GenreScoreCategory
    framing: Optional[Dict[str, Union[float, int, str]]] = None
    manipulation: Optional[Dict[str, Union[float, int, str]]] = None
